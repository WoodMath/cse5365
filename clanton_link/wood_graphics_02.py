...
class cl_world:
    ...
    def create_graphic_objects(self,canvas,mesh):
        ...
        print(' mesh.vertices = ' + str(mesh.vertices))
        print(' len(mesh.vertices) = ' + str(len(mesh.vertices)))
    ...
    def new_redisplay(self,canvas,event):
        self.create_graphic_objects(canvas,self.mesh)
